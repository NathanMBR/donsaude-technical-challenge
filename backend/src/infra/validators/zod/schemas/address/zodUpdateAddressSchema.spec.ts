...
import { zodUpdateAddressSchema } from './zodUpdateAddressSchema'

type SchemaInfer = zod.infer<typeof zodUpdateAddressSchema>
type SUTSuccessResponse = SafeParseSuccess<SchemaInfer>
type SUTFailResponse = SafeParseError<SchemaInfer>

/* eslint-disable @typescript-eslint/no-non-null-assertion */
describe('zodUpdateAddressSchema', () => {
  it('should successfully validate a update address payload', () => {
    ...
    const SUTResponse = zodUpdateAddressSchema.safeParse(SUTRequest) as SUTSuccessResponse

    expect(SUTResponse.success).toBe(true)
    expect(SUTResponse.data).toEqual(SUTRequest)
  })

  it('should successfully validate a update address payload with null values', () => {
    const SUTRequest = {
      postalCode: 'test_postal_code',
      street: 'test_street',
      number: 'test_number',
  ...
  it('should successfully validate a update address payload with undefined values', () => {
    const SUTRequest = {
      postalCode: 'test_postal_code',
      street: 'test_street',
      number: 'test_number',
  ...
  it("should fail validation if postalCode isn't defined", () => {
    ...
    const SUTResponse = zodUpdateAddressSchema.safeParse(SUTRequest) as SUTFailResponse
